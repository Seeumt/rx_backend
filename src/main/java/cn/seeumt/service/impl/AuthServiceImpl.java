...
//import cn.seeumt.utils.JwtUtils;
...
//            throw new TipsException(ResultCode.BAD_REQUEST.getCode(), "用户已存在");
//        }
...
//            // TODO: 2020/1/11  这里为什么把用户名和密码放进去就可以了呢？
//            return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(username, password));
//        } catch (DisabledException | BadCredentialsException e) {
//            throw new TipsException(ResultCode.LOGIN_ERROR.getCode(), e.getMessage());
//        }
//    }
//}
