...
public class AliyunMessageUtil {
     ...
     * a
     */
    private static final String ACCESS_KEY_ID = "LTAI4Fh4RFMVfD8NUngPEAfV";
    /**
     * k
     */
        private static final String ACCESS_KEY_SECRET = "RQhZJ857cGvf8mdPlpsD8uVLMLeCAq";
    ...
    public static SendSmsResponse sendSmsWel(String telephone,String password) throws com.aliyuncs.exceptions.ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("Tips");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_184105883");
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
